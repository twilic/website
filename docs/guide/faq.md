...
The specification is finalized. The seven official SDKs (Rust, Go, Python, JavaScript/TypeScript, Java, Ruby, Zig) are conformance-tested against shared binary fixtures generated by the Rust reference implementation.
...
Yes. This is a primary design goal. All seven official SDKs target the v2 wire format and are tested for interoperability. A payload encoded by the Rust SDK is correctly decoded by the Go, Python, Java, Ruby, Zig, and JavaScript SDKs.
